...
By default, the Prisma Cloud System Admin role is mapped to the xref:../authentication/user_roles.adoc[Prisma Cloud Compute Administrator role].

For automated workflows, you'll want to xref:../authentication/access_keys.adoc[provision a service account] with the minimum required permissions.
...
COMPUTE_CONSOLE = \https://<LOAD_BALANCER>:8083
